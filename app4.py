...
st.sidebar.title("Bem-vindo ao Chat com Izuela!")
st.sidebar.write("Faça uma pergunta na caixa de texto ao lado e Izuela responderá.")
...
def main():
    ...
    with col1:
        col1.header("Faça uma pergunta a Izuela")
